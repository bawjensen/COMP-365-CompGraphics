...
#include <iostream.h>								// Include the standard input output stream
...
///////////////////////////////////////  \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
bool TextureSystem::FileExist(char *mFileName)
{
...
///////////////////////////////////////  \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
bool TextureSystem::LoadTexture(UINT &mTexture, char *mFileName, bool IsJPG)
{
	if ( DEBUG ) {	cout << "Loading Texture: " << mFileName << "...";   }

	ImageDataRec *mImage = NULL;
	
	if (!FileExist(mFileName))							//check to see if the file exists
	{	
		if ( DEBUG ) {	cout << "Failed!!! - File does not exist" << endl ;   }
		return false;	
	}	
